<div class="{{ $bgColor }} text-white shadow-md rounded-lg p-4 flex flex-col items-center relative w-full">
    ...
    <div class="self-start ml-4">
        <h2 class="text-3xl font-bold">{{ $KhoaCount }}</h2>  
        <p class="text-lg">Khoa</p>
    </div>

    <!-- Ảnh avatar -->
    <div class="absolute right-4 bottom-16 opacity-30">
        <img src="{{ asset('images/school.jpg') }}" alt="User Avatar" class="w-14 h-14 object-cover rounded-full">
    </div>

    <!-- Nút More Info -->
    <a href="{{ route('admin.manage-khoa') }}" 
